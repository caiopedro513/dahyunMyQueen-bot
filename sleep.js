            ...
            switch(choice){
                case "expensive" :
                    ...
                    //paid
                        ...
                        updateUserStats(username, 0, hotels[choice].energy, -hotels[choice].price, 0, 0, 0).then(function(){
                ...
                case "cheap" :
                    ...
                    //paid
                        ...
                        //robbed
                        if (rolled >= 95){
                            updateUserStats(username, -25, -15, -userstats.money, 0, 0, 0).then(function(){
                                getUserStats(username, username).then(function(userstats){
                                    updateSlotStats(hotels[choice].price);
